...
{
    public partial class butadd : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("INSERT INTO[THURSDAY](trno,arrtime,deptime,stations,actdeact,classes,facilities)VALUES('" + trno + "','" + artime + "','" + dptime + "','" + stations + "','" + actdact + "','" + clz + "','" + fac + "')", conn);
        ...
        private void butsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("SELECT* FROM[THURSDAY]WHERE trno='" + trno + "'", conn);
        ...
        private void butupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("UPDATE[THURSDAY]SET arrtime='" + artime + "',deptime='" + dptime + "',stations='" + stations + "',actdeact='" + actdact + "',classes='" + clz + "',facilities='" + fac + "'WHERE trno='" + trno + "'", conn);
                comm.ExecuteNonQuery();
        ...
        private void butdelete_Click(object sender, EventArgs e)
        {
            ...
            if (res == DialogResult.Yes)
            {
                try
                {
                    ...
                    trno = Convert.ToInt32(txttrno.Text);
                    conn.Open();
                    SqlCommand comm = new SqlCommand("DELETE FROM[THURSDAY]WHERE trno='" + trno + "'", conn);
                    comm.ExecuteNonQuery();
                    txttrno.Clear();
                    txtartime.Clear();
                    txtdptime.Clear();
