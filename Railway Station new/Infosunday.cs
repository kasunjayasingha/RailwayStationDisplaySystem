...
{
    public partial class Infosunday : Form
    {
        ...
        private void butadd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("INSERT INTO[SUNDAY](trno,arrtime,deptime,stations,actdeact,classes,facilities)VALUES('" + trno + "','" + artime + "','" + dptime + "','" + stations + "','" + actdact + "','" + clz + "','" + fac + "')", conn);
        ...
        private void butsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("SELECT* FROM[SUNDAY]WHERE trno='" + trno + "'", conn);
        ...
        private void butupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                conn.Open();
                SqlCommand comm = new SqlCommand("UPDATE[SUNDAY]SET arrtime='" + artime + "',deptime='" + dptime + "',stations='" + stations + "',actdeact='" + actdact + "',classes='" + clz + "',facilities='" + fac + "'WHERE trno='" + trno + "'", conn);
                comm.ExecuteNonQuery();
        ...
        private void butdelete_Click(object sender, EventArgs e)
        {
            ...
            if (res == DialogResult.Yes)
            {
                try
                {
                    ...
                    trno = Convert.ToInt32(txttrno.Text);
                    conn.Open();
                    SqlCommand comm = new SqlCommand("DELETE FROM[SUNDAY]WHERE trno='" + trno + "'", conn);
                    comm.ExecuteNonQuery();
                    txttrno.Clear();
                    txtartime.Clear();
                    txtdptime.Clear();
        ...
        {
            DisplaySampleSun sun = new DisplaySampleSun();
            this.Hide();
            sun.Show();
        }
        //CLEAR Button
